...
- детали задачи (до 500 символов) не дублируй информацию из заголовка.
...
- выбери подходящую категорию только из списка.
- выбери приоритет.

Верни только объект JSON без форматирования и рассуждений.
...
4. Текст задания: "В среду сходить в кино"
